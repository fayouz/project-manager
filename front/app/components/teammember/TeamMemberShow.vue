<template>
  <UCard>
    ...
    <div v-if="item" class="divide-y divide-neutral-200 dark:divide-neutral-800">
      ...
      <div class="py-3 sm:grid sm:grid-cols-3 sm:gap-4">
        <dt class="text-sm font-medium text-neutral-500 capitalize">team</dt>
...
async function load() {
  ...
  try {
    const data = await useFetchItem<TeamMember>(`team_members/${idToLoad}`);
