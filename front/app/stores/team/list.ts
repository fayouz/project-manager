...
export const useTeamListStore = defineStore("teamList", {
  ...
  actions: {
    setData({ items, view, isLoading, error, hubUrl }: FetchAllData<Team>) {
    ...
    updateItem(updatedItem: Team) {
      const item: Team | undefined = this.items.find(
