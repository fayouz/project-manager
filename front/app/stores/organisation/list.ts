...
export const useOrganisationListStore = defineStore("organisationList", {
  ...
  actions: {
    ...
    updateItem(updatedItem: Organisation) {
      const item: Organisation | undefined = this.items.find(
    ...
    deleteItem(deletedItem: Organisation) {
